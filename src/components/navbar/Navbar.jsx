...
return (
    ...
    <p className="text-blue"><span className='text-blue text-md'>By</span> <a href="https://github.com/JAS-D98" className='capitalize text-blue underline text-md'>Jasper Ngunjiri</a></p>
    <div>
